...
LIB_PATH = COMMON_DIR
LIBS = ["libgcc.a", "stdlib.a", "siwkapi.a", "stdlib.a", "libgcc.a"]
...
def Make():	
	...
	ExecCommandCritical(LD + " --no-undefined " + " ".join(OBJECTS) + " " + " ".join(LIBS) + " -o " + BUILD_DIR + PROGRAM_NAME + ".elf -T program.ld", 0)
