...
void InvalidateDataCacheRange (uint32 nAddress, uint32 nLength) __attribute__ ((optimize (3)));
void CleanDataCacheRange (uint32 nAddress, uint32 nLength) __attribute__ ((optimize (3)));
void CleanAndInvalidateDataCacheRange (uint32 nAddress, uint32 nLength) __attribute__ ((optimize (3)));
